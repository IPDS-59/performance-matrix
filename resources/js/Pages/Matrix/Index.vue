        ...
        <div class="overflow-auto rounded-md border bg-white" style="max-height: calc(100vh - 260px)">
            <table class="min-w-max text-xs">
                <thead class="sticky top-0 z-10 bg-white">
                    <tr>
                        <th class="sticky left-0 z-20 bg-white px-3 py-2 text-left font-medium border-b border-r min-w-[160px]">
                            Pegawai
                        </th>
                        <th
                ...
                <tbody>
                    <tr v-for="employee in employees" :key="employee.id" :class="['border-b', employee.id === currentEmployeeId ? 'bg-primary/5 hover:bg-primary/10' : 'hover:bg-gray-50']">
                        <td :class="['sticky left-0 z-10 border-r px-3 py-1.5 font-medium', employee.id === currentEmployeeId ? 'bg-primary/5 text-primary font-semibold' : 'bg-white']">
