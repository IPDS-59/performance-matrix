                        ...
                        <div v-if="report.attachments.length">
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    ...
                                    <a
                                        v-if="att.display_url || att.url"
                                        :href="att.display_url || att.url!"
                                        target="_blank"
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        >
                                            ...
                                            <a
                                                ...
                                                title="Buka di tab baru"
                                            >
                                                <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2h-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                                            </a>
                                            <span :class="['shrink-0 rounded border px-1.5 py-0.5 text-[10px]', attachmentStatusColor(att.status)]">
                                                {{ attachmentStatusLabel(att.status) }}
                                            </span>
        ...
        <DialogContent class="max-w-3xl p-0 overflow-hidden">
            <DialogHeader class="px-4 py-3 border-b">
                <div class="flex items-center gap-2 min-w-0">
                    <DialogTitle class="truncate text-sm flex-1">{{ previewAttachment ? attachmentLabel(previewAttachment) : '' }}</DialogTitle>
                    <a
                        v-if="previewAttachment && (previewAttachment.display_url || previewAttachment.url)"
                        :href="previewAttachment.display_url || previewAttachment.url!"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="shrink-0 text-gray-400 hover:text-gray-600"
                        title="Buka di tab baru"
