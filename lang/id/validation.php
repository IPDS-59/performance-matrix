...
return [
    ...
    'password'             => [
        ...
        'uncompromised' => ':attribute yang diberikan pernah bocor dalam kebocoran data. Harap pilih :attribute yang berbeda.',
    ],
    ...
    'custom' => [
        ...
        'password' => ['required' => 'Kata sandi wajib diisi.', 'min' => 'Kata sandi minimal :min karakter.'],
        'url'      => ['url' => 'URL bukti dukung harus valid (dimulai dengan https://).'],
    ],
    ...
    'attributes' => [
        ...
        'token'                 => 'token',
        'team_id'               => 'tim',
        'week_start'            => 'minggu awal',
        'period_type'           => 'jenis periode',
        'period_year'           => 'tahun',
        'period_month'          => 'bulan',
        'period_quarter'        => 'triwulan',
        'performance_plan_id'   => 'rencana kinerja',
        'obstacle'              => 'kendala',
        'solution'              => 'solusi',
        'follow_up_plan'        => 'RTL',
